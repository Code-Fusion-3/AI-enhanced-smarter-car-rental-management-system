            ...
            ?> text-white px-6 py-3">
                <div class="flex justify-between items-center">
                    <div class="flex items-center">
                        ...
                        <h2 class="text-xl font-bold">Rental #<?= $rental['rental_id'] ?> -
                            <?= ucfirst($rental['status']) ?></h2>
                    </div>
                    <div>
            ...
            <div class="p-6 border-b">
                <div class="flex flex-col md:flex-row">
                    ...
                    <div class="md:w-2/3 md:pl-6">
                        <h3 class="text-2xl font-bold text-gray-900 mb-2"><?= $rental['make'] ?> <?= $rental['model'] ?>
                            <?= $rental['created_at'] ?></h3>
                        ...
                        <div class="flex items-center mt-1">
                            ...
                            <div>
                                <p class="text-gray-900 font-medium">
                                    ...
                                    <?= date('M d, Y', strtotime($rental['end_date'])) ?></p>
                                <?php
                        ...
                        <div class="mt-4 md:mt-0 md:text-right">
                            ...
                            <div class="mt-2">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium 
                                    ...
                                    <svg class="ml-1 h-3 w-3 text-green-500" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd"
            ...
            <div class="p-6 border-b">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <p class="text-gray-900 mt-1"><?= date('M d, Y g:i A', strtotime($history['return_date'])) ?>
                        </p>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <p class="text-red-600 font-medium mt-1"><?= formatCurrency($history['additional_charges']) ?>
                        </p>
                    </div>
                    <?php endif; ?>
            ...
            <div class="p-6 flex flex-wrap gap-3 justify-end">
                ...
                <a href="index.php?page=rentals&action=extend&id=<?= $rental['rental_id'] ?>"
                    ...
                    <svg class="-ml-1 mr-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                        fill="currentColor">
                        <path fill-rule="evenodd"
                            d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 001.415-1.414L11 9.586V6z"
                            clip-rule="evenodd" />
                    </svg>
                    Extend Rental
                </a>
        ...
        <div class="mt-8">
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-md">
                <ul class="divide-y divide-gray-200">
                    ...
                    <li>
                        <a href="index.php?page=rentals&action=view&id=<?= $related['rental_id'] ?>"
                                ...
                                <div class="mt-2 sm:flex sm:justify-between">
                                    <div class="sm:flex">
                                        <p class="flex items-center text-sm text-gray-500">
                                            ...
                                            <?= date('M d, Y', strtotime($related['end_date'])) ?>
                                        </p>
                                    </div>
                                </div>
                            </div>
...
<div id="extendRentalModal"
    ...
    <div class="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
        ...
        <form action="index.php?page=rentals&action=extend_submit" method="POST">
            ...
            <div class="mb-4">
                <label for="current_end_date" class="block text-sm font-medium text-gray-700 mb-1">Current End
                    Date</label>
                <input type="text" id="current_end_date" value="<?= date('M d, Y', strtotime($rental['end_date'])) ?>"
                    class="bg-gray-100 w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm text-gray-700"
                    readonly>
            </div>
            ...
            <div class="mb-4">
                <label for="extension_reason" class="block text-sm font-medium text-gray-700 mb-1">Reason for
                    Extension</label>
                <textarea id="extension_reason" name="extension_reason" rows="3"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                    placeholder="Please provide a reason for extending your rental..."></textarea>
            </div>
