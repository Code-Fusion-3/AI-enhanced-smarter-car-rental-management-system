        ...
        <div class="max-w-md w-full space-y-8">
            <div>
                ...
                <p class="mt-2 text-center text-sm text-gray-600">
                    Sign in to access your AI-powered car rental experience
                </p>
            </div>
                    ...
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-blue-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zm-1 7a1 1 0 01-1 1h-1a1 1 0 110-2h1a1 1 0 011 1z" clip-rule="evenodd" />
                            </svg>
                        </div>
                        <div class="ml-3">
            ...
            <form class="mt-8 space-y-6 bg-white p-8 rounded-xl shadow-md" action="index.php?page=auth&action=login" method="POST">
            ...
            <div class="text-center mt-4">
                ...
                <a href="index.php?page=auth&action=register" class="font-medium text-blue-600 hover:text-blue-500 inline-flex items-center mt-1">
                    Create an account
        ...
        <div class="relative h-full flex flex-col justify-center px-12 py-12 z-10">
            ...
            <div class="space-y-6">
                <div class="flex items-start">
                    ...
                    <div class="ml-4">
                        <h3 class="text-xl font-semibold text-white">AI-Powered Recommendations</h3>
                        <p class="mt-1 text-blue-100">Get personalized car suggestions based on your preferences and past rentals.</p>
                    </div>
                </div>
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="mt-1 text-blue-100">Enjoy fair prices adjusted in real-time based on demand and availability.</p>
                    </div>
                </div>
                ...
                <div class="flex items-start">
                    ...
                    <h3 class="text-xl font-semibold text-white">24/7 AI Assistant</h3>
                        <p class="mt-1 text-blue-100">Get instant answers and support through our intelligent chat assistant.</p>
                    </div>
                </div>
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="mt-1 text-blue-100">Your data and payments are protected with enterprise-grade security.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-10">
                <div class="bg-white bg-opacity-10 rounded-lg p-6 backdrop-filter backdrop-blur-sm">
                    <div class="flex items-start">
                        <svg class="h-8 w-8 text-yellow-300" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="ml-4">
                            <p class="text-white italic">"The AI assistant made finding the right car so easy! It recommended the perfect SUV for our family trip and even applied a discount automatically."</p>
