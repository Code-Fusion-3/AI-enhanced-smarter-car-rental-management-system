...
<div class="bg-white">
        ...
        <div class="max-w-6xl mx-auto px-4 py-24 relative z-10">
            <div class="md:w-2/3">
                <h1 class="text-5xl font-bold text-white mb-4 leading-tight">
                    AI-Enhanced <span class="text-yellow-300">Smart Car Rental</span> For The Modern Driver
                </h1>
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="index.php?page=cars"
                        class="bg-white text-blue-600 px-8 py-4 rounded-lg font-semibold hover:bg-blue-50 transition shadow-lg inline-flex items-center justify-center">
                    ...
                    <a href="#how-it-works"
                        class="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-blue-600 transition inline-flex items-center justify-center">
    ...
    <div class="max-w-6xl mx-auto px-4 py-16">
        <div class="text-center mb-12">
            ...
            <p class="text-gray-600 max-w-2xl mx-auto">Discover our selection of premium vehicles available for rent.
                From economic options to luxury experiences.</p>
        </div>
    ...
    <div id="how-it-works" class="bg-gray-50 py-16">
        <div class="max-w-6xl mx-auto px-4">
            <div class="text-center mb-12">
                ...
                <p class="text-gray-600 max-w-2xl mx-auto">Renting a car has never been easier. Our AI-Enhanced platform
    ...
    <div class="max-w-6xl mx-auto px-4 py-16">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
                <h2 class="text-3xl font-bold text-gray-800 mb-6">AI-Enhanced Rental Experience</h2>
                <p class="text-gray-600 mb-8">Our smart car rental system leverages artificial intelligence to provide
                    you with a seamless and personalized experience.</p>
                ...
                <div class="space-y-6">
                    <div class="flex">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-gray-600 mt-1">Our AI analyzes your preferences and past rentals to suggest
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-gray-600 mt-1">Get the best rates with our AI-Enhanced pricing system that
                                adjusts in real-time based on demand and availability.</p>
                        </div>
                    </div>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-gray-600 mt-1">Our intelligent chatbot is always available to answer your
                                questions and guide you through the rental process.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="relative">
                    ...
                    <div class="bg-white rounded-lg shadow-lg p-6">
                        ...
                        <div class="mt-4 space-y-3">
                            ...
                            <div class="bg-blue-100 rounded-lg p-3 text-sm text-blue-700">
                                Great choice! I recommend our Honda CR-V or Toyota RAV4. Both have ample space for 5
                                passengers and luggage. Would you like to see availability for this weekend?
                            </div>
                            <div class="bg-gray-100 rounded-lg p-3 text-sm text-gray-700">
                                Yes, and what special offers do you have?
                            </div>
                            <div class="bg-blue-100 rounded-lg p-3 text-sm text-blue-700">
                                You're in luck! We currently have a WEEKEND25 promotion with 25% off weekend rentals. I
                                can apply this to your booking automatically.
                            </div>
                        </div>

                        <div class="mt-4 flex">
                            <input type="text" placeholder="Ask our AI assistant..."
                                class="flex-1 border border-gray-300 rounded-l-lg px-4 py-2 text-sm focus:outline-none focus:border-blue-500">
                            <button
                                class="bg-blue-600 text-white rounded-r-lg px-4 py-2 text-sm hover:bg-blue-700 transition">
                ...
                <!-- Decorative elements -->
                <div class="absolute top-0 right-0 -mr-6 -mt-6 w-32 h-32 bg-yellow-400 rounded-full opacity-50 z-0">
                </div>
                <div class="absolute bottom-0 left-0 -ml-6 -mb-6 w-24 h-24 bg-blue-400 rounded-full opacity-50 z-0">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="max-w-6xl mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div>
                    ...
                    <p class="text-blue-100 mb-6">Take advantage of our limited-time offers and save on your next
                        rental.</p>
                    ...
                    <a href="index.php?page=promotions"
                        class="inline-block mt-4 bg-white text-blue-600 px-6 py-3 rounded-lg font-semibold hover:bg-blue-50 transition">
                        View All Promotions
                    </a>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-xl overflow-hidden">
                    <div class="p-8">
                        ...
                        <p class="text-gray-600 mb-6">Join our community and get exclusive access to special offers,
                            early bird discounts, and personalized recommendations.</p>
    ...
    <div class="max-w-6xl mx-auto px-4 py-16">
        <div class="text-center mb-12">
            ...
            <p class="text-gray-600 max-w-2xl mx-auto">Hear from our satisfied customers about their experience with our
                AI-enhanced car rental service.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white p-6 rounded-xl shadow-md">
                ...
                <p class="text-gray-600">"The AI assistant made finding the right car so easy! It recommended the
                    perfect SUV for our family trip and even applied a discount automatically. Seamless experience from
                    start to finish."</p>
            </div>
            ...
            <div class="bg-white p-6 rounded-xl shadow-md">
                ...
                <p class="text-gray-600">"I love the dynamic pricing feature! I was able to get a luxury car at an
                    economy price by booking during a low-demand period. The AI chatbot helped me understand when the
                    best time to book would be."</p>
            </div>
            ...
            <div class="bg-white p-6 rounded-xl shadow-md">
                ...
                <p class="text-gray-600">"The WEEKEND25 promotion saved me a lot on my weekend getaway. The Tesla Model
                    3 was in perfect condition and the entire rental process was smooth. Will definitely use this
                    service again!"</p>
            </div>
        </div>
        ...
        <div class="bg-gray-50 py-16">
            <div class="max-w-6xl mx-auto px-4">
                <div class="text-center mb-12">
                    ...
                    <p class="text-gray-600 max-w-2xl mx-auto">We offer a wide range of vehicles to meet every need and
                        budget.</p>
                </div>
        ...
        <div class="bg-blue-600 py-16">
            <div class="max-w-6xl mx-auto px-4 text-center">
                ...
                <p class="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">Join thousands of satisfied customers who have
                    transformed their travel experience with our AI-Enhanced car rental system.</p>
                <div class="flex flex-col sm:flex-row justify-center gap-4">
                    <a href="index.php?page=cars"
                        class="bg-white text-blue-600 px-8 py-4 rounded-lg font-semibold hover:bg-blue-50 transition">
        ...
        <div class="max-w-6xl mx-auto px-4 py-16">
            <div class="text-center mb-12">
                ...
                <p class="text-gray-600 max-w-2xl mx-auto">Find answers to common questions about our smart car rental
                    service.</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md">
                    ...
                    <p class="text-gray-600">Our AI analyzes your preferences, past rentals, and current needs to
                        suggest vehicles that best match your requirements. It learns from your feedback to improve
                        future recommendations.</p>
                </div>

                <div class="bg-white p-6 rounded-xl shadow-md">
                    <h3 class="text-xl font-bold text-gray-800 mb-3">What is dynamic pricing?</h3>
                    <p class="text-gray-600">Dynamic pricing adjusts rental rates based on demand, seasonality, and
                        availability. This ensures you get competitive rates during off-peak times and helps us manage
                        inventory during high-demand periods.</p>
                </div>

                <div class="bg-white p-6 rounded-xl shadow-md">
                    <h3 class="text-xl font-bold text-gray-800 mb-3">How do I apply a promotion code?</h3>
                    <p class="text-gray-600">During the checkout process, you'll find a field to enter your promotion
                        code. Our system will automatically apply the discount to your total. Some promotions may be
                        applied automatically if you qualify.</p>
                </div>

                <div class="bg-white p-6 rounded-xl shadow-md">
                    <h3 class="text-xl font-bold text-gray-800 mb-3">What happens if I need to cancel my reservation?
                    </h3>
                    <p class="text-gray-600">You can cancel your reservation through your account dashboard.
                        Cancellation policies vary depending on how far in advance you cancel. Full details are provided
