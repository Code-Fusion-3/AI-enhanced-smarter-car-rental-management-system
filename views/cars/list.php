...
<div class="bg-gray-50 min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="relative z-10">
                ...
                <p class="mt-4 text-xl text-blue-100 max-w-3xl">
                    Find the perfect vehicle for your journey with our AI-Enhanced recommendations and dynamic pricing.
                </p>
                ...
                <div class="mt-8 bg-white rounded-lg shadow-lg p-6">
                    <form action="index.php" method="GET" class="space-y-5">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                            ...
                            <div>
                                <label for="price" class="block text-sm font-medium text-gray-700 mb-1">Max
                                    Price</label>
                        ...
                        <div x-data="{ open: false }">
                            <button type="button" @click="open = !open"
                                ...
                                <svg :class="{'rotate-90': open}"
                                    class="h-5 w-5 mr-1 transform transition-transform duration-200"
                            ...
                            <div x-show="open" x-transition class="mt-4 grid grid-cols-1 md:grid-cols-3 gap-5">
                                <div>
                                    <label for="fuel_type" class="block text-sm font-medium text-gray-700 mb-1">Fuel
                                        Type</label>
                                    <select name="fuel_type" id="fuel_type"
                                        class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md">
                                        <option value="">Any Fuel Type</option>
                                        <?php foreach ($fuelTypes as $type): ?>
                                            <option value="<?php echo $type; ?>" <?php echo (isset($_GET['fuel_type']) && $_GET['fuel_type'] == $type) ? 'selected' : ''; ?>>
                                ...
                                <div>
                                    ...
                                    <select name="transmission" id="transmission"
                                        ...
                                        <?php foreach ($transmissions as $trans): ?>
                                            <option value="<?php echo $trans; ?>" <?php echo (isset($_GET['transmission']) && $_GET['transmission'] == $trans) ? 'selected' : ''; ?>>
                                ...
                                <div>
                                    <label for="seats" class="block text-sm font-medium text-gray-700 mb-1">Minimum
                                        Seats</label>
                                    <select name="seats" id="seats"
                                        class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md">
                                        <option value="">Any Number of Seats</option>
                                        <?php for ($i = 2; $i <= 8; $i++): ?>
                                            <option value="<?php echo $i; ?>" <?php echo (isset($_GET['seats']) && $_GET['seats'] == $i) ? 'selected' : ''; ?>>
                                                <?php echo $i; ?>+ seats
                                            </option>
                                        <?php endfor; ?>
                                    </select>
                                ...
                                <?php if (isAdmin()): ?>
                                    <div>
                                        <label class="flex items-center">
                                            ...
                                            <span class="ml-2 text-sm text-gray-700">Show all cars (including
                                                unavailable)</span>
                                        </label>
                                    </div>
                                <?php endif; ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="flex justify-between items-center mb-8">
            ...
            <?php if (isAdmin()): ?>
                <a href="index.php?page=cars&action=add"
                    class="inline-flex items-center bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition-colors duration-300">
                    ...
                    <div class="ml-4 flex flex-wrap gap-2">
                        <?php if (!empty($_GET['search'])): ?>
                            <span
                                ...
                                <a href="<?php echo removeQueryParam('search'); ?>"
                        ...
                        <?php if (!empty($_GET['category'])):
                            ...
                            <span
                                ...
                                <a href="<?php echo removeQueryParam('category'); ?>"
                                    class="ml-1 text-blue-500 hover:text-blue-700">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20"
                                        fill="currentColor">
                                        <path fill-rule="evenodd"
                        ...
                        <?php if (!empty($_GET['fuel_type'])): ?>
                            <span
                                ...
                                <a href="<?php echo removeQueryParam('fuel_type'); ?>"
                                    class="ml-1 text-blue-500 hover:text-blue-700">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20"
                                        fill="currentColor">
                                        <path fill-rule="evenodd"
                        ...
                        <?php if (!empty($_GET['transmission'])): ?>
                            <span
                                ...
                                <a href="<?php echo removeQueryParam('transmission'); ?>"
                                    class="ml-1 text-blue-500 hover:text-blue-700">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20"
                                        fill="currentColor">
                                        <path fill-rule="evenodd"
                        ...
                        <?php if (!empty($_GET['seats'])): ?>
                            <span
                                ...
                                <a href="<?php echo removeQueryParam('seats'); ?>"
                                    class="ml-1 text-blue-500 hover:text-blue-700">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20"
                                        fill="currentColor">
                                        <path fill-rule="evenodd"
                    ...
                    <div class="bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl">
                        <div class="relative">
                            ...
                            <?php if ($car['status'] !== 'available'): ?>
                                <div
                                    class="absolute top-0 right-0 bg-red-500 text-white px-3 py-1 m-2 rounded-full text-xs font-semibold uppercase">
                            ...
                            ?>
                            <div
                                class="absolute top-0 left-0 bg-blue-600 text-white px-3 py-1 m-2 rounded-full text-xs font-semibold">
                        ...
                        <div class="sm:flex">
                            <div class="bg-white bg-opacity-10 backdrop-filter backdrop-blur-sm rounded-md px-6 py-4">
                                ...
                                <div class="flex items-center">
                                    <span
                                        class="text-2xl font-mono text-white tracking-wider"><?= htmlspecialchars($promotion['code']) ?></span>
                                    <button onclick="copyPromoCode('<?= htmlspecialchars($promotion['code']) ?>')"
                                        class="ml-3 bg-white bg-opacity-20 p-2 rounded-md hover:bg-opacity-30 focus:outline-none">
                            ...
                            <?php if (isLoggedIn()): ?>
                                <div class="mt-3 sm:mt-0 sm:ml-3">
                                    <a href="index.php?page=cars"
                                        class="block w-full rounded-md bg-white px-5 py-4 text-base font-medium text-blue-600 shadow hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-blue-600 sm:px-10">
                                        Browse Cars
                                    </a>
                                </div>
                            <?php else: ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <?php else: ?>
                <div class="bg-blue-50 rounded-lg p-8 text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-blue-500 mx-auto mb-4" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
