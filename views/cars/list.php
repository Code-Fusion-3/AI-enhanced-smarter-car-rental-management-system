                            ...
                            <div>
                                ...
                                <select name="sort" id="sort"
                                    ...
                                    <option value="newest"
                                        ...
                                        Newest Models</option>
                                    <option value="oldest"
                                        <?php echo (isset($_GET['sort']) && $_GET['sort'] == 'oldest') ? 'selected' : ''; ?>>
                                        Oldest Models</option>
                        ...
                        <div x-data="{ open: false }">
                            <div class="flex items-center space-x-2 mb-2">
                                ...
                                <button type="button" @click="open = !open"
                                    ...
                                    aria-expanded="open" aria-controls="advanced-filters-panel">
