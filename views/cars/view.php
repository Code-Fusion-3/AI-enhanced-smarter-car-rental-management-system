                        ...
                        <div class="border-t border-gray-200 pt-6 flex justify-between">
                            <div>
                                ...
                                <div class="flex space-x-3">
                                    <a href="index.php?page=cars&action=edit&id=<?= $car['car_id'] ?>" 
                                    ...
                                    <a href="index.php?page=cars&action=maintenance&id=<?= $car['car_id'] ?>" 
                                    ...
                                    <a href="index.php?page=cars&action=delete&id=<?= $car['car_id'] ?>" 
                            ...
                            <div>
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-<?= $car['status'] === 'available' ? 'green' : ($car['status'] === 'maintenance' ? 'yellow' : 'red') ?>-100 text-<?= $car['status'] === 'available' ? 'green' : ($car['status'] === 'maintenance' ? 'yellow' : 'red') ?>-800">
                                    Status: <?= ucfirst(htmlspecialchars($car['status'])) ?>
                                </span>
                            </div>
                        </div>
                        <?php endif; ?>
