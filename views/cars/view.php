            ...
            <div class="relative z-10">
                <nav class="flex mb-4" aria-label="Breadcrumb">
                    <ol class="flex items-center space-x-2 text-sm text-blue-200">
                        ...
                        <li class="flex items-center">
                            ...
                            <span
                                class="ml-2 text-white font-medium"><?= htmlspecialchars($car['make'] . ' ' . $car['model']) ?></span>
                        </li>
                    </ol>
                </nav>
                ...
                <div class="mt-3 flex items-center">
                    ...
                    <div class="flex items-center">
                        ...
                        <?php endif; ?>
                        <?php endfor; ?>
                        <span class="ml-2 text-white"><?= number_format($avgRating, 1) ?> (<?= $reviewCount ?>
                            reviews)</span>
                    </div>
                    <?php else: ?>
                    <span class="bg-blue-700 text-white px-3 py-1 rounded-full text-sm font-medium">No reviews
                        yet</span>
                    <?php endif; ?>
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="relative">
                        ...
                        <div
                            class="absolute top-0 right-0 bg-red-500 text-white px-4 py-2 m-4 rounded-full text-sm font-semibold uppercase">
                    ...
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-6">
                            <div>
                                ...
                                <span
                                    class="ml-2 bg-green-100 text-green-800 text-xs font-semibold px-2.5 py-0.5 rounded">
                                    <?= round((($car['base_rate'] - $car['daily_rate']) / $car['base_rate']) * 100) ?>%
                                    OFF
                                </span>
                                <?php elseif ($car['daily_rate'] > $car['base_rate']): ?>
                                <span
                                    class="ml-2 bg-yellow-100 text-yellow-800 text-xs font-semibold px-2.5 py-0.5 rounded">
                                    High Demand
                                </span>
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                            ...
                            <div class="bg-gray-50 p-3 rounded-lg text-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mx-auto text-gray-500 mb-2"
                                ...
                                <div class="text-base font-semibold text-gray-900">
                                    <?= ucfirst(htmlspecialchars($car['transmission'])) ?></div>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="bg-gray-50 p-3 rounded-lg text-center">
                                ...
                                <div class="text-base font-semibold text-gray-900">
                                    <?= ucfirst(htmlspecialchars($car['fuel_type'])) ?></div>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="bg-gray-50 p-3 rounded-lg text-center">
                                ...
                                <div class="text-base font-semibold text-gray-900">
                                    <?= htmlspecialchars($car['seats']) ?></div>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="bg-gray-50 p-3 rounded-lg text-center">
                                ...
                                <div class="text-base font-semibold text-gray-900"><?= htmlspecialchars($car['year']) ?>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="border-b border-gray-200 pb-6 last:border-b-0 last:pb-0">
                                <div class="flex items-center mb-3">
                                    <div
                                        ...
                                        <?php else: ?>
                                        <span
                                            class="text-blue-600 font-bold"><?= strtoupper(substr($review['username'], 0, 2)) ?></span>
                                        <?php endif; ?>
                                    </div>
                                    <div>
                                        <h4 class="text-sm font-semibold text-gray-900">
                                            <?= htmlspecialchars($review['full_name']) ?></h4>
                                        <div class="flex items-center">
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden mb-12 z-100">
                    ...
                    <div class="p-6">
                        ...
                        <form action="index.php?page=rentals&action=create" method="POST">
                            ...
                            <div class="mb-4">
                                <label for="start_date" class="block text-sm font-medium text-gray-700 mb-1">Pickup
                                    Date</label>
                            ...
                            <div class="mb-4">
                                <label for="end_date" class="block text-sm font-medium text-gray-700 mb-1">Return
                                    Date</label>
                            ...
                            <?php if ($promotion): ?>
                            <div class="mb-4">
                                <label for="promo_code" class="block text-sm font-medium text-gray-700 mb-1">Promo
                                    Code</label>
                                <div class="flex">
                                ...
                                <p class="mt-1 text-xs text-green-600 hidden" id="promo-success">Promo code applied
                                    successfully!</p>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="mb-6">
                                <div class="flex justify-between py-2 text-sm">
                                    ...
                                    <span
                                        class="text-gray-900 font-medium"><?= formatCurrency((float)$car['daily_rate']) ?></span>
                                </div>
                                ...
                                <div class="flex justify-between py-2 text-sm border-t border-gray-200">
                                    ...
                                    <span class="text-gray-900 font-medium" id="subtotal">RWF 0</span>
                                </div>
                                <?php if ($promotion): ?>
                                <div class="flex justify-between py-2 text-sm border-t border-gray-200 text-green-600"
                                    id="discount-row" style="display: none;">
                                    <span>Discount (<?= $promotion['discount_percentage'] ?>%):</span>
                                    <span id="discount-amount">RWF 0</span>
                                </div>
                                <?php endif; ?>
                                <div class="flex justify-between py-3 text-base font-semibold border-t border-gray-200">
                                    <span class="text-gray-900">Total:</span>
                                    <span class="text-blue-600" id="total">RWF 0</span>
                                </div>
                            </div>
                        ...
                        function calculateTotal() {
                            ...
                            if (startDate && endDate && startDate < endDate) {
                                ...
                                document.getElementById('subtotal').textContent = 'RWF ' + Math.round(subtotal);

                                let total = subtotal;

                                if (promoApplied && discountPercentage > 0) {
                                    const discountAmount = subtotal * (discountPercentage / 100);
                                    document.getElementById('discount-amount').textContent = 'RWF ' + Math.round(
                                        discountAmount);
                                    document.getElementById('discount-row').style.display = 'flex';
                                    total = subtotal - discountAmount;
                                }

                                document.getElementById('total').textContent = 'RWF ' + Math.round(total);
                            }
                        }
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            ...
                            <a href="index.php?page=cars&action=view&id=<?= $similarCar['car_id'] ?>"
                                class="block group">
                                <div class="flex items-center">
