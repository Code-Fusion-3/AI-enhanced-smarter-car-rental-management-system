                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-800">RWF
                                <?= number_format($stats['totalRevenue'], 2) ?></p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-3 gap-4 mt-4">
                        <div class="text-center">
                            ...
                            <p class="text-lg font-semibold text-indigo-600">
                                RWF <?= number_format($stats['weeklyRevenue'], 2) ?></p>
                        </div>
                        <div class="text-center">
                            <p class="text-sm text-gray-600">This Month</p>
                            <p class="text-lg font-semibold text-indigo-600">
                                RWF <?= number_format($stats['monthlyRevenue'], 2) ?></p>
                        </div>
                        <div class="text-center">
                            <p class="text-sm text-gray-600">Total</p>
                            <p class="text-lg font-semibold text-indigo-600">
                                RWF <?= number_format($stats['totalRevenue'], 2) ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white rounded-lg shadow overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-4 text-center">
                            <a href="index.php?page=admin&action=rentals&filter=pending"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white rounded-lg shadow overflow-hidden">
                    ...
                    <div class="p-6">
                                    ...
                                    <div class="ml-4 flex-1">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <p class="text-sm font-semibold text-green-600">
                                                RWF <?= number_format($car['revenue'] ?? 0, 2) ?>
                                            </p>
                                        </div>
                        ...
                        <div class="mt-4 text-center">
                            <a href="index.php?page=admin&action=cars&sort=performance"
                                class="text-sm font-medium text-blue-600 hover:text-blue-500">
                                View all cars
                            </a>
                        </div>
