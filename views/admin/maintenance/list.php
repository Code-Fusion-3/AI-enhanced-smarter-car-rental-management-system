...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="index.php?page=admin&action=maintenance&subaction=add" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">
            Add New Maintenance
        </a>
    </div>
            ...
            <div class="w-full md:w-64">
                ...
                <select id="car_id" name="car_id" 
                    ...
                    <?php foreach ($cars as $car): ?>
                        <option value="<?= $car['car_id'] ?>" <?= (isset($_GET['car_id']) && $_GET['car_id'] == $car['car_id']) ? 'selected' : '' ?>>
