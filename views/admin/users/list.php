            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-6 mr-12">
                <form action="index.php" method="GET" class="flex flex-wrap items-end gap-4">
                    ...
                    <div class="w-full md:w-auto flex gap-2">
                        ...
                        <a href="index.php?page=admin&action=users" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-300 transition-colors duration-300">
                            Reset
                        </a>
                    </div>
                </form>
                                    ...
                                    <tr>
                                            ...
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 h-10 w-10">
                                                    <?php if (!empty($user['profile_image'])): ?>
                                                        <img class="h-10 w-10 rounded-full" src="<?= $user['profile_image'] ?>" alt="<?= htmlspecialchars($user['username']) ?>">
                                                    <?php else: ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            ...
                                            <?php if ($user['role'] === 'admin'): ?>
                                                <a href="index.php?page=admin&action=users&subaction=edit&id=<?= $user['user_id'] ?>" 
                                            ...
                                            <?php else: ?>
                                                <span class="text-gray-400 cursor-not-allowed" title="Cannot edit non-admin users">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                                        <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
                                                    </svg>
                                                </span>
...
<script>
    function confirmDelete(userId, username) {
        document.getElementById('modal-description').textContent = `Are you sure you want to delete the user "${username}"? This action cannot be undone.`;
