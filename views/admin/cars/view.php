        ...
        <div class="flex-1 p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3">
                    ...
                    <div class="md:col-span-2 p-6">
                        ...
                        <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <dl class="space-y-3">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <dd class="text-sm text-gray-900">
                                            <?= $category ? htmlspecialchars($category['name']) : 'Uncategorized' ?>
                                        </dd>
                                    </div>
                                    <div class="flex justify-between">
                                        <dt class="text-sm font-medium text-gray-500">Fuel Type</dt>
                                        <dd class="text-sm text-gray-900">
                                            <?= !empty($car['fuel_type']) ? ucfirst($car['fuel_type']) : 'N/A' ?>
                                        </dd>
                                    </div>
                                    <div class="flex justify-between">
                                        <dt class="text-sm font-medium text-gray-500">Transmission</dt>
                                        <dd class="text-sm text-gray-900">
                                            <?= !empty($car['transmission']) ? ucfirst($car['transmission']) : 'N/A' ?>
                                        </dd>
                                    </div>
                                    <div class="flex justify-between">
                                        <dt class="text-sm font-medium text-gray-500">Seats</dt>
                                        <dd class="text-sm text-gray-900">
                                            <?= !empty($car['seats']) ? $car['seats'] : 'N/A' ?>
                                        </dd>
                                    </div>
                                    <div class="flex justify-between">
                                        <dt class="text-sm font-medium text-gray-500">Mileage</dt>
                                        <dd class="text-sm text-gray-900">
                                            <?= !empty($car['mileage']) ? number_format($car['mileage']) . ' km' : 'N/A' ?>
                                        </dd>
                                    </div>
                                </dl>
                            </div>
                            ...
                            <div>
                                <h3 class="text-lg font-medium text-gray-900 border-b pb-2 mb-3">Pricing Information
                                </h3>
                                <dl class="space-y-3">
                                    <div class="flex justify-between">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <dd class="text-sm text-gray-900"><?= formatCurrency($car['base_rate']) ?></dd>
                                    </div>
                                    <div class="flex justify-between">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <dd class="text-sm text-gray-900">
                                            <?= !empty($car['monthly_rate']) ? 'RWF' . number_format($car['monthly_rate'], 2) : 'N/A' ?>
                                        </dd>
                                    </div>
                                </dl>
                            </div>
            ...
            <div class="mb-6">
                <div class="sm:hidden">
                    ...
                    <select id="tabs" name="tabs" onchange="showTab(this.value)"
                ...
                <div class="hidden sm:block">
                    <div class="border-b border-gray-200">
                        <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                            <a href="#" onclick="showTab('rental-history'); return false;"
                                class="tab-link active border-blue-500 text-blue-600 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm"
                                data-tab="rental-history">
                                Rental History
                            </a>
                ...
                <div id="rental-history" class="tab-content">
                    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                        <div class="px-4 py-5 sm:px-6 flex justify-between items-center">
                            ...
                            <a href="index.php?page=admin&action=rentals&car_id=<?= $car['car_id'] ?>"
                                class="inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-md text-blue-700 bg-blue-100 hover:bg-blue-200">
                                View All Rentals
                            </a>
                        </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <?= !empty($rental['total_cost']) ? formatCurrency($rental['total_cost']) : '-' ?>
                                        </td>
                    ...
                    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                        <div class="px-4 py-5 sm:px-6 flex justify-between items-center">
                            <div>
                                ...
                                <p class="mt-1 max-w-2xl text-sm text-gray-500">Service history and upcoming maintenance
                                </p>
                            </div>
                            <a href="index.php?page=admin&action=maintenance&car_id=<?= $car['car_id'] ?>"
                                class="inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-md text-blue-700 bg-blue-100 hover:bg-blue-200">
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <?= !empty($record['cost']) ? formatCurrency($record['cost']) : 'N/A' ?>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                ...
                <div id="analytics" class="tab-content hidden">
                    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                        <div class="px-4 py-5 sm:px-6">
                            ...
                            <p class="mt-1 max-w-2xl text-sm text-gray-500">Rental statistics and performance metrics
                            </p>
                        </div>
                        ...
                        <div class="px-4 py-5 sm:p-6">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div class="bg-white p-6 rounded-lg border border-gray-200">
                                    ...
                                    <div class="flex items-baseline">
                                        ...
                                        ?>
                                        <span
                                            class="text-3xl font-semibold text-blue-600"><?= $utilizationRate ?>%</span>
                                ...
                                <div class="bg-white p-6 rounded-lg border border-gray-200">
                                    ...
                                    <div class="flex items-baseline">
                                        ...
                                        ?>
                                        <span
                                            class="text-3xl font-semibold text-green-600"><?= formatCurrency($totalRevenue) ?></span>
                                        <span class="ml-2 text-sm text-gray-500">total</span>
                                    </div>
                                    <p class="mt-2 text-sm text-gray-500">From <?= count($rentalHistory) ?> completed
                                        rentals</p>
                                </div>
                            ...
                            <div class="mt-8">
                                ...
                                <p class="mt-2 text-sm text-gray-500 text-center">Monthly rental revenue and utilization
...
function showTab(tabId) {
    ...
    document.querySelector(`.tab-link[data-tab="${tabId}"]`).classList.add('active', 'border-blue-500',
        'text-blue-600');
