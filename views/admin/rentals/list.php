                ...
                <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                    <form action="index.php" method="GET" class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div>
                                <label for="date_to" class="block text-sm font-medium text-gray-700 mb-1">To
                                    Date</label>
                    ...
                    <div class="border-b border-gray-200">
                        <nav class="-mb-px flex space-x-8">
                            <a href="index.php?page=admin&action=rentals"
                                ...
                                All Rentals
                                <span
                                    class="ml-2 py-0.5 px-2.5 text-xs font-medium rounded-full <?= empty($status) ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-900' ?>">
                                    <?= $totalCount ?? 0 ?>
                                </span>
                            </a>
                            ...
                            <a href="index.php?page=admin&action=rentals&status=pending"
                                ...
                                Pending
                                <span
                                    class="ml-2 py-0.5 px-2.5 text-xs font-medium rounded-full <?= isset($status) && $status === 'pending' ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-900' ?>">
                            ...
                            <a href="index.php?page=admin&action=rentals&status=approved"
                                ...
                                Approved
                                <span
                                    class="ml-2 py-0.5 px-2.5 text-xs font-medium rounded-full <?= isset($status) && $status === 'approved' ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-900' ?>">
                            ...
                            <a href="index.php?page=admin&action=rentals&status=active"
                                ...
                                Active
                                <span
                                    class="ml-2 py-0.5 px-2.5 text-xs font-medium rounded-full <?= isset($status) && $status === 'active' ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-900' ?>">
                            ...
                            <a href="index.php?page=admin&action=rentals&status=completed"
                                ...
                                Completed
                                <span
                                    class="ml-2 py-0.5 px-2.5 text-xs font-medium rounded-full <?= isset($status) && $status === 'completed' ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-900' ?>">
                            ...
                            <a href="index.php?page=admin&action=rentals&status=cancelled"
                                ...
                                Cancelled
                                <span
                                    class="ml-2 py-0.5 px-2.5 text-xs font-medium rounded-full <?= isset($status) && $status === 'cancelled' ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-900' ?>">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                <div class="flex items-center">
                                                    <div
                                                        ...
                                                        <span
                                                            class="text-xs font-medium"><?= strtoupper(substr($rental['username'], 0, 2)) ?></span>
                                                    </div>
                                                    <div class="ml-3">
                                                        <div class="text-sm font-medium text-gray-900">
                                                            <?= htmlspecialchars($rental['username']) ?></div>
                                                        <div class="text-xs text-gray-500">
                                                            <?= htmlspecialchars($rental['full_name']) ?></div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
