...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-2">
            <a href="index.php?page=admin&action=rentals" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-md text-sm">
                Back to Rentals
            </a>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <h4 class="text-sm font-medium text-gray-500 uppercase tracking-wider mb-2">Rental Period</h4>
                            <div class="bg-gray-50 rounded-lg p-4">
                                <div class="flex items-center mb-2">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-sm text-gray-500"><?= date('F j, Y', strtotime($rental['start_date'])) ?></div>
                                    </div>
                                </div>
                                <div class="flex items-center mb-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-sm text-gray-500"><?= date('F j, Y', strtotime($rental['end_date'])) ?></div>
                                    </div>
                                </div>
                        ...
                        <div>
                            <h4 class="text-sm font-medium text-gray-500 uppercase tracking-wider mb-2">Pricing Details</h4>
                            <div class="bg-gray-50 rounded-lg p-4">
                                ...
                                <div class="flex justify-between mb-2">
                                    ...
                                    <span class="text-sm font-medium text-gray-900"><?= $duration ?> days</span>
                                </div>
                                <div class="flex justify-between mb-2">
                                    <span class="text-sm text-gray-500">Base Cost:</span>
                                    <span class="text-sm font-medium text-gray-900">$<?= number_format($rental['daily_rate'] * $duration, 2) ?></span>
                                </div>
                                
                                <?php if (!empty($rental['discount_amount']) && $rental['discount_amount'] > 0): ?>
                                <div class="flex justify-between mb-2">
                                    <span class="text-sm text-gray-500">Discount:</span>
                                    <span class="text-sm font-medium text-green-600">-$<?= number_format($rental['discount_amount'], 2) ?></span>
                                </div>
                                <?php endif; ?>
                                ...
                                <div class="flex justify-between mb-2">
                                    ...
                                    <span class="text-sm font-medium text-red-600">+$<?= number_format($rental['additional_charges'], 2) ?></span>
                                </div>
                                <?php endif; ?>
                                ...
                                <div class="border-t border-gray-200 mt-2 pt-2 flex justify-between">
                                    ...
                                    <span class="text-sm font-bold text-gray-900">$<?= number_format($rental['total_cost'], 2) ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-6">
                        <h4 class="text-sm font-medium text-gray-500 uppercase tracking-wider mb-2">Location Information</h4>
                        <div class="bg-gray-50 rounded-lg p-4">
                                ...
                                <div>
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-sm text-gray-500"><?= !empty($rental['pickup_location']) ? htmlspecialchars($rental['pickup_location']) : 'Not specified' ?></div>
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <div class="text-sm font-medium text-gray-900">Return Location</div>
                                            <div class="text-sm text-gray-500"><?= !empty($rental['return_location']) ? htmlspecialchars($rental['return_location']) : 'Not specified' ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <?php if (!empty($rental['notes'])): ?>
                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            <p class="text-sm text-gray-700 whitespace-pre-line"><?= htmlspecialchars($rental['notes']) ?></p>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="mt-6">
                        <h4 class="text-sm font-medium text-gray-500 uppercase tracking-wider mb-2">Applied Promotion</h4>
                        <div class="bg-gray-50 rounded-lg p-4 flex items-center">
                            <div class="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-xs font-semibold mr-3">
                                <?= htmlspecialchars($promotion['code']) ?>
                            </div>
                            <p class="text-sm text-gray-700"><?= htmlspecialchars($promotion['description']) ?></p>
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden mt-6">
                ...
                <div class="p-6">
                    ...
                    <div class="mt-4 bg-gray-50 rounded-lg p-4">
                        ...
                        <p class="text-sm text-gray-600 italic">"<?= htmlspecialchars($rentalHistory[0]['feedback']) ?>"</p>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-6">
                    <div class="flex items-center mb-4">
                        ...
                        <div class="ml-4">
                            <h4 class="text-lg font-medium text-gray-900"><?= htmlspecialchars($user['full_name']) ?></h4>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="text-sm text-gray-600"><?= htmlspecialchars($user['phone']) ?></span>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="text-sm text-gray-600">License: <?= htmlspecialchars($user['driver_license']) ?></span>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="flex items-start">
                            ...
                            <span class="text-sm text-gray-600"><?= nl2br(htmlspecialchars($user['address'])) ?></span>
                        </div>
                        <?php endif; ?>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden mt-6">
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center mb-4">
                        ...
                        <span class="ml-2 px-2 py-1 text-xs font-semibold rounded-full <?= $car['status'] === 'available' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' ?>">
                            <?= ucfirst($car['status']) ?>
                        </span>
                    </div>
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center">
                            ...
                            <span class="text-sm text-gray-600">Daily Rate: $<?= number_format($car['daily_rate'], 2) ?></span>
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="text-sm text-gray-600">Registration: <?= htmlspecialchars($car['registration_number']) ?></span>
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="text-sm text-gray-600">Fuel Type: <?= ucfirst($car['fuel_type']) ?></span>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="text-sm text-gray-600">Transmission: <?= ucfirst($car['transmission']) ?></span>
                        </div>
                        <?php endif; ?>
                    ...
                    <div class="mt-4 pt-4 border-t border-gray-200">
                        <a href="index.php?page=admin&action=cars&subaction=view&id=<?= $car['car_id'] ?>" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
