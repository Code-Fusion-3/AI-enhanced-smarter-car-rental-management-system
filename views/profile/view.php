                ...
                <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                    <div class="flex flex-col md:flex-row items-center">
                        ...
                        <div class="flex-1 text-center md:text-left">
                            <h1 class="text-2xl font-bold text-gray-800"><?= htmlspecialchars($userData['full_name']) ?>
                            </h1>
                            ...
                            <?php endif; ?>
                            <div class="mt-4">
                                <a href="index.php?page=profile&action=edit"
                                ...
                                <a href="index.php?page=profile&action=password"
                                    class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ml-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" viewBox="0 0 20 20"
                                        fill="currentColor">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-gray-900">
                                <?= !empty($userData['phone']) ? htmlspecialchars($userData['phone']) : 'Not provided' ?>
                            </p>
                        </div>
                        <div>
                            <h3 class="text-sm font-medium text-gray-500">Driver's License</h3>
                            <p class="mt-1 text-gray-900">
                                <?= !empty($userData['driver_license']) ? htmlspecialchars($userData['driver_license']) : 'Not provided' ?>
                            </p>
                        </div>
                        <div class="md:col-span-2">
                            <h3 class="text-sm font-medium text-gray-500">Address</h3>
                            <p class="mt-1 text-gray-900">
                                <?= !empty($userData['address']) ? htmlspecialchars($userData['address']) : 'Not provided' ?>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                    ...
                    <div class="text-center py-8">
                        ...
                        <a href="index.php?page=cars"
                            class="mt-3 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700">
                            Browse Cars
                        </a>
                    </div>
                    <?php else: ?>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                        ...
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10">
                                                <img class="h-10 w-10 rounded-full object-cover"
                                                    src="<?= !empty($rental['image_url']) ? $rental['image_url'] : 'assets/images/default-car.jpg' ?>"
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        RWF <?= number_format($rental['total_cost'], 2) ?>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        ...
                                        <a href="index.php?page=rentals&action=cancel&id=<?= $rental['rental_id'] ?>"
                                            ...
                                            onclick="return confirm('Are you sure you want to cancel this rental?')">Cancel</a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        ...
                                        <a href="index.php?page=rentals&action=review&id=<?= $rental['rental_id'] ?>"
                                            class="ml-3 text-green-600 hover:text-green-900">Review</a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
